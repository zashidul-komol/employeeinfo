...
class HomeController extends Controller {
	...
	public function index() {
		...
		return view('dashboards.index', compact('depots', 'items', 'shops', 'payment', 'bkash', 'canApply', 'requisitions', 'stockReceive', 'depostDfStatus', 'df_returns', 'complainStatus', 'regionalDfStatus', 'damage_applications', 'mapDatas', 'employees','divisions','districts', 'thanas'));
	}
