...
<div class="row animated fadeInRight">
    ...
    <div class="col-sm-12">
        <h4 class="section-subtitle"><b>Update Prof. Degree</b></h4>
        <span class="pull-right">
            {!! Html::decode(link_to_route('profDegrees.index','<i class="fa fa-list"></i>',[],array('class'=>'btn btn-success btn-right-side'))) !!}
        </span>
        <div class="panel">
            <div class="panel-content">
              ...
              <div class="active tab-pane" id="personal">
                  {{ Form::model($profDegrees,array('route' => array('profDegrees.update',$profDegrees->id),'method' => 'PUT','enctype'=>'multipart/form-data','class'=>'form-horizontal')) }}
                  <!-- .tab-pane -->
                  <div class="tab-pane" id="employment">
                      <form class="form-horizontal">
                          <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                {{Form::text('name_prof_degree',null,array('class' => 'form-control'))}}
                                {!! $errors->first('name_prof_degree', '<p class="text-danger">:message</p>' ) !!}
                              </div>
                              <div class="col-sm-2">
