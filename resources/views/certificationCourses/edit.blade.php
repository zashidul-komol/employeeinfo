...
<div class="row animated fadeInRight">
    ...
    <div class="col-sm-12">
        <h4 class="section-subtitle"><b>Update Certification Course</b></h4>
        ...
        <div class="panel">
            <div class="panel-content">
              ...
              <div class="active tab-pane" id="personal">
                  {{ Form::model($certificationCourses,array('route' => array('certificationCourses.update',$certificationCourses->id),'method' => 'PUT','enctype'=>'multipart/form-data','class'=>'form-horizontal')) }}
                  <!-- .tab-pane -->
