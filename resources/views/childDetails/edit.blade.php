...
<div class="row animated fadeInRight">
    ...
    <div class="col-sm-8">
        <h4 class="section-subtitle"><b>Edit Child Details</b></h4>
        <span class="pull-right">
            {!! Html::decode(link_to_route('childDetails.create','<i class="fa fa-list"></i>',[],array('class'=>'btn btn-success btn-right-side'))) !!}
        </span>
        <div class="panel">
            <div class="panel-content">
              ...
              <div class="active tab-pane" id="personal">
                  {{ Form::model($childDetails,array('route' => array('childDetails.update',$childDetails->id),'method' => 'PUT','enctype'=>'multipart/form-data','class'=>'form-horizontal')) }}
              <!-- .tab-pane -->
