...
<div class="row animated fadeInRight">
    ...
    <div class="col-sm-12">
        <h4 class="section-subtitle"><b>Shop Update</b></h4>
        <span class="pull-right">
            {!! Html::decode(link_to_route('shops.index','<i class="fa fa-list"></i>',[],array('class'=>'btn btn-success btn-right-side'))) !!}
        </span>
        <div class="panel">
            <div class="panel-content">
                 {{ Form::model($shops,array('route' => array('shops.update',$shops->id),'method' => 'PUT','enctype'=>'multipart/form-data','class'=>'form-horizontal')) }}
