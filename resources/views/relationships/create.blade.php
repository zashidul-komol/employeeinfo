...
<div class="row animated fadeInRight">
    ...
    <div class="col-sm-12">
        <h4 class="section-subtitle"><b>Add Child Details</b></h4>
        <span class="pull-right">
            {!! Html::decode(link_to_route('childDetails.index','<i class="fa fa-list"></i>',[],array('class'=>'btn btn-success btn-right-side'))) !!}
        </span>
        <div class="panel">
                  ...
                  <div class="tab-pane" id="child">
                      <form class="form-horizontal">
                          <div class="form-group">
                            <label for="inputName" class="col-sm-2 control-label">Employees Name </label>
                            <div class="col-xs-4">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-4">
                                {{Form::select('institution',[''=>'--Please Select Occupation--']+['Pre-Primary'=>'Pre-Primary','Primary'=>'Primary', 'High School'=>'High School','College'=>'College','University'=>'University'],null,array('class' => 'form-control'))}}
