...
<div class="row animated fadeInRight">
    <div class="col-sm-12">
        <h4 class="section-subtitle"><b>Stock Add</b></h4>
        <span class="pull-right">
            {!! Html::decode(link_to_route('inventories.stockIndex','<i class="fa fa-list"></i>',[],array('class'=>'btn btn-success btn-right-side'))) !!}
        </span>
        <div class="panel">
            <div class="panel-content">
				{{ Form::model(request()->old(),array('route' => array('inventories.stockCreate'),'enctype'=>'multipart/form-data','class'=>'form-horizontal')) }}
                    ...
                    <div class="form-group{{ $errors->has('lc_date') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <div class="input-group">
                                <span class="input-group-addon x-primary"><i class="fa fa-calendar"></i></span>
                                {{Form::text('lc_date',null,array('class' => 'form-control datepicker'))}}
                            </div>
                        </div>
                    </div>
