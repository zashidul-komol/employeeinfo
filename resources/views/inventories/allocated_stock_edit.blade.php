    ...
    <div class="col-sm-12">
        ...
        <div class="panel">
            ...
            <div class="panel-content">
                ...
                <div class="row">
                    {{ Form::model(request()->old(),array('route' => array('inventories.allocatedStockEdit',$stock->id),'method'=>'PUT','class'=>'form-horizontal')) }}
                    ...
                    <div class="widget-list list-to-do col-md-4">
                        <h4 class="list-title">
                            ...
                            @php
                               $listsObj=getLists($allocations,$dkey);
                            @endphp
                        </h4>
                        ...
                        <ul class="bodyul">
                            ...
                            <li>
                                <div class="form-group">
                                    ...
                                    @else
                                        {{Form::label($dval->size->name,null,array('class' => 'control-label col-sm-4'))}}
                                    @endif
                                    <div class="col-md-8">
                                        {{Form::number('data['.$loop->parent->iteration.'][details]['.$dval->id.']',collect($listsObj)->pull($dval->id),array('class' => 'form-control c-'.$dff,'onChange'=>"countVal('".$dff."',this)",'onfocus'=>"countVal('".$dff."',this)",'min'=>0))}}
                                    </div>
                                </div>
                            </li>
                           @endforeach
