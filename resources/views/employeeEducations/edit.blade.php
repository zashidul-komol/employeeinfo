...
<div class="content-header">
    <div class="leftside-content-header">
        <ul class="breadcrumbs">
            <li><i class="fa fa-table" aria-hidden="true"></i><a href="#">Employee Education Details</a></li>
            <li><a>Update</a></li>
        </ul>
    </div>
</div>
<div class="row animated fadeInRight">
    ...
    <div class="col-sm-12">
        <h4 class="section-subtitle"><b>Update Employee Education</b></h4>
        <span class="pull-right">
            {!! Html::decode(link_to_route('employeeEducations.index','<i class="fa fa-list"></i>',[],array('class'=>'btn btn-success btn-right-side'))) !!}
        </span>
        <div class="panel">
            <div class="panel-content">
              ...
              <div class="active tab-pane" id="personal">
                  {{ Form::model($employeeEducations,array('route' => array('employeeEducations.update',$employeeEducations->id),'method' => 'PUT','enctype'=>'multipart/form-data','class'=>'form-horizontal')) }}
                  <!-- .tab-pane -->
