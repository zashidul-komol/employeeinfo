...
return [
	...
	'menu' => [
	    ...
	    'sms' => ['SmsController'],
	    'inventory' => ['SuppliersController', 'InventoriesControler','EmployeesController','FamilyDetailsController', 'ChildDetailsController', 'JobExperiancesController', 'EmployeeEducationsController', 'CertificationCoursesController','ProfDegreesController','SiblingDetailsController', 'EmployeePromotionHistoryController','EmployeeTrainingHistoryController','EmployeeTransferHistoryController'],
